...
class transformer(nn.Module):
    ...
    def __init__(self, voc_size, d_model=512, nhead=8, num_layers=2):
        super(transformer, self).__init__()

        self.embedding1 = nn.Embedding(voc_size, d_model)
...
class Transformer_():
    ...
    def __init__(self, voc, d_model=512, nhead=8, num_layers=2):
        self.transformer = transformer(
            voc_size=voc.vocab_size,
            d_model=d_model,
            nhead=nhead,
    ...
    def sample(self, batch_size, max_length=140):
        ...
        for step in range(max_length):
            logits= self.transformer(sequences) # [B, V]
