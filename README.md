...
Download the necessary environment packages and data from the [Zenodo repository](https://doi.org/10.5281/zenodo.20066519). After downloading, place `data_with_predictor.tar.gz` in the KinTrans folder and extract it using the following command：
```bash
tar -xzvf data_with_predictor.tar.gz
```
